...
def launch_setup(context):
    ...
    color_detect_node = Node(
        ...
        output='screen',
        parameters=[os.path.join(example_package_path, 'config/roi.yaml'), {'enable_display': enable_display, 'enable_roi_display': enable_roi_display, 'use_depth_cam': use_depth_cam}]
    )
