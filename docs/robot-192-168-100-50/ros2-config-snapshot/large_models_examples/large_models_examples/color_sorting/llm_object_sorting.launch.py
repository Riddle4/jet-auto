...
def launch_setup(context):
    ...
    camera_topic = LaunchConfiguration('camera_topic', default='/usb_cam/image_raw')
    ...
    object_sorting_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(large_models_examples_package_path, 'large_models_examples','color_sorting', 'object_sorting_node.launch.py')),
    )
